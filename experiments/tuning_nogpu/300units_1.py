...
RAM AFTER LOADING DATA: 0.2886085510253906
RAM BEFORE CLASSIFER: 0.2908134460449219
RAM AFTER CLASSIFER: 0.2927360534667969
RAM BEFORE PRE-TRAINING 0.2927360534667969
RAM AFTER PRE-TRAINING 0.3221435546875
RAM BEFORE GENERATOR: 0.3221435546875
RAM AFTER DECLARING GENERATOR: 0.3221435546875
MACs of root classifier 772000
MACs of top classifier: 39680
RAM BEFORE REPORTING: 0.3221435546875
...
splitMNIST5-task--CNN_CLASSIFIER_c10--i500-lr0.001-b128-adam--generative-VAE(MLP([300, 300, 300])--z100-c10)-s2651
...
--> this network has 454610 parameters (~0.5 million)
      of which: - learnable: 454610 (~0.5 million)
                - fixed: 0 (~0.0 million)
------------------------------------------------------------------------------------------
RAM BEFORE TRAINING: 0.3221435546875
CPU BEFORE TRAINING: (92.5, 2.1)

Training...
PEAK TRAINING RAM: 0.3779792785644531
RAM BEFORE EVALUATION: 0.3648490905761719
CPU BEFORE EVALUATION: (2184.9, 80.07)
...
=> Total training time = 358.7 seconds

RAM AT THE END: 0.3743934631347656
CPU AT THE END: (2191.12, 81.43)
